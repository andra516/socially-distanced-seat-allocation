...
def saveSession(saveDirectory, Xs, Ys):
    '''
    Function that saves the progress made in selecting seats in a given room plan (currently PRE-ALLOCATION)
    ...
    ## Rewrite item with key seatPixelCoords with the new seatPixelCoords
...
def loadSession(directory):
    ...
    from given directory (CURRENTLY PRE-ALLOCATION).
